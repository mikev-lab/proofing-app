import { auth, db, functions } from './firebase.js'; // <-- Import 'functions' here
...
// Import only httpsCallable, not getFunctions
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // const functions = getFunctions(); // <-- Remove this line
