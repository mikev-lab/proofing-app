...
If you see `Access to XMLHttpRequest blocked by CORS policy` in your browser console, you need to allow your frontend URL in the Medusa backend configuration.

1.  Open your **Railway Project**.
2.  Go to **Variables**.
3.  Add or Update `STORE_CORS`:
    *   Value: `https://your-firebase-site.web.app,http://localhost:3000` (Comma separated, no spaces)
4.  Add or Update `ADMIN_CORS`:
    *   Value: `https://your-firebase-site.web.app,http://localhost:3000`
5.  Redeploy.
