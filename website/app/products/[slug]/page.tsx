        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-12 lg:items-start">
            ...
            <div className="mt-10 lg:mt-0">
                ...
                <div className="mt-10 flex gap-4">
                    <a href="/legacy-portal/index.html" className="flex-1 bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-indigo-500">
                        Get a Quote
                    </a>
