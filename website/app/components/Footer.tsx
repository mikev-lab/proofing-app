        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="mt-6 flex items-start space-x-2">
                 ...
                 <div className="text-sm text-gray-400">
                    ...
                    <p>11033 118th Pl NE.<br/>Kirkland, WA 98033</p>
                 </div>
            </div>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link href="/services/crowdfunding" className="text-base text-gray-400 hover:text-white transition-colors">Crowdfunding & Fulfillment</Link></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link href="/resources" className="text-base text-gray-400 hover:text-white transition-colors">Print Guides & Articles</Link></li>
              <li><Link href="/conventions" className="text-base text-gray-400 hover:text-white transition-colors">Convention Guide</Link></li>
              <li><Link href="/publishers" className="text-base text-gray-400 hover:text-white transition-colors">For Publishers</Link></li>
