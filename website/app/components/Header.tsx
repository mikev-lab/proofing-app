        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <div className="relative group">
              <button className="text-gray-300 group-hover:text-white px-3 py-2 rounded-md text-sm font-medium inline-flex items-center transition-colors">
          ...
          <div className="flex items-center space-x-4">
            <a href="/legacy-portal/index.html" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors">
              Log in
            </a>
            <a href="/legacy-portal/register.html" className="bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-sm">
              Register
            </a>
          </div>
        </div>
