...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Successful login - redirect to dashboard (or admin if role check needed, but dashboard usually redirects admins)
      // For now, let's send everyone to /admin as requested by the task context involving admin dashboard work
      router.push('/admin');
    } catch (err: any) {
