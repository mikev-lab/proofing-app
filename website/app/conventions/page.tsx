...
import ConventionFinder from '../components/ConventionFinder';
    ...
    <div className="bg-slate-900 min-h-screen">
      ...
      <section className="py-12 bg-slate-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {/* Convention Finder (with Integrated Sort/Search) */}
              <div className="mb-16">
                   <ConventionFinder events={eventsData} />
              </div>

              {/* Browse by Category (Legacy/Alternate View) */}
              <div>
