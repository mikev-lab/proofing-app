...
function mapMedusaProduct(product: any): ProductData {
    ...
    if (typeof window === 'undefined') { // Server-side log
        ...
        console.log(`[Medusa Debug] Raw metadata:`, JSON.stringify(metadata, null, 2));
        console.log(`[Medusa Debug] metadata.features type: ${typeof metadata.features}`);
        console.log(`[Medusa Debug] metadata.features value:`, metadata.features);
    }
