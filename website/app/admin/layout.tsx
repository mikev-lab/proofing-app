  ...
  return (
    <AdminGuard>
        ...
        <aside className="w-64 bg-slate-950 border-r border-slate-800 flex-shrink-0 fixed h-full z-10">
            ...
            <Link href="/admin/quoting" className="flex items-center px-4 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-slate-800 hover:text-white">
                <svg className="mr-3 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-8 mb-2">Settings</p>
            <Link href="/admin/settings/paper-sizes" className="flex items-center px-4 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-slate-800 hover:text-white">
                <svg className="mr-3 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
